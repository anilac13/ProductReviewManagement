            ...
            while (flag)
            {
                ...
                switch (option)
                {
                    case 1:
                        ...
                        productReviews.Add(new ProductReview {ProductID = 13, UserID =13, Rating=2.8, Review="Fine", IsLike = true});
                        productReviews.Add(new ProductReview {ProductID = 14, UserID =14, Rating=3.5, Review="Good", IsLike = false});
                        productReviews.Add(new ProductReview {ProductID = 15, UserID =15, Rating=4.3, Review="Excellent", IsLike = true});
                        ...
                        productReviews.Add(new ProductReview {ProductID = 18, UserID =18, Rating=4.5, Review="Awesome", IsLike = true});
                        ...
                        productReviews.Add(new ProductReview {ProductID = 21, UserID =21, Rating=3.3, Review="Good", IsLike = true});
